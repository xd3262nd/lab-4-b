...
class TestStudentLists(TestCase):
    ...
    def test_remove_students_not_in_list(self):
        test_class = ClassList(4)
        test_class.add_student('Student01')
        test_class.add_student('Student02')
        test_class.add_student('Student03')
        with self.assertRaises(StudentError):
            test_class.remove_student('Student10')

    ## TODO write a test that removes a student from an empty list, and asserts a StudentError is raised
    def test_remove_students_from_empty_list(self):
        test_class = ClassList(4)
        with self.assertRaises(StudentError):
            test_class.remove_student('Student1234')
    ...
    def test_student_that_is_not_enrolled(self):
        test_class = ClassList(4)
        test_class.add_student('Student01')
        test_class.add_student('Student02')
        test_class.add_student('Student03')
        self.assertFalse(test_class.is_enrolled('Student100'))
    ...
    # use assertIsNone.
    def test_no_index_for_empty_list(self):
        test_class = ClassList(2)
        self.assertIsNone(test_class.index_of_student('Student112'))
    ...
    def test_index_for_student_not_in_list(self):
        test_class = ClassList(4)
        test_class.add_student('Jimmy')
        test_class.add_student('Winy')
        test_class.add_student('Amy')
        self.assertIsNone(test_class.index_of_student('Kimmy'))

    ## TODO write a test for your new is_class_full method when the class is full.
    # use assertTrue.
    def test_class_is_full(self):
        test_class = ClassList(4)
        test_class.add_student('You')
        test_class.add_student('Kou')
        test_class.add_student('Rou')
        test_class.add_student('Lou')
    ...
    def test_class_is_not_full(self):
        test_class = ClassList(4)
        test_class.add_student('Will')
        test_class.add_student('Bill')
        test_class.add_student('Sill')
